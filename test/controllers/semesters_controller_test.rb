...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference("Semester.count") do
      post semesters_url, params: { semester: { end_date: @semester.end_date, name: @semester.name, start_date: @semester.start_date, year: @semester.year } }
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { end_date: @semester.end_date, name: @semester.name, start_date: @semester.start_date, year: @semester.year } }
